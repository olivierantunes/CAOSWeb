 ...
 */
exports.register_blog = function (b) {
 ...
 * @return (String): "ok" or "ko"
 */
exports.confirm_registration_blog = function () {
 ...
 * @return (String): "ok" or "ko"
 */
exports.register_caosweb = function (b) {
	var userTemporaryId = db.create_ID (b.pseudo);
	util.log ("userId: " + userTemporaryId);
 ...
 * @return (String): "ok" or "ko"
 */
exports.confirm_registration_caosweb = function (id) {
